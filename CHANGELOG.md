...
## [16.0.0](https://github.com/absidue/YouTube.js/compare/v15.0.1...v16.0.0) (2025-08-30)
...
* **StreamingInfoOptions:** Add `is_sabr` option ([#974](https://github.com/absidue/YouTube.js/issues/974))
* Remove `web.bundle.min`
* **parser:** Remove old comment node
* **Log:** Convert Log class to module ([#814](https://github.com/absidue/YouTube.js/issues/814))
* **parser:** Remove getters that have been deprecated for a long time ([#815](https://github.com/absidue/YouTube.js/issues/815))
* **parser:** Implement endpoint/command parsers ([#812](https://github.com/absidue/YouTube.js/issues/812))
...
* **OAuth2:** Rewrite auth module ([#661](https://github.com/absidue/YouTube.js/issues/661))
* **toDash:** Add support for generating manifests for Post Live DVR videos ([#580](https://github.com/absidue/YouTube.js/issues/580))
...
* **account:** Add missing property `channel_handle` ([#789](https://github.com/absidue/YouTube.js/issues/789)) ([677e1f0](https://github.com/absidue/YouTube.js/commit/677e1f08075a4a59274f89f3eb65967d7d0ab01b))
* **Actions:** Allow auth check to be skipped ([67f13ff](https://github.com/absidue/YouTube.js/commit/67f13fffacec2c655a03d66c6d8016620d9abcf9))
* add `FeedNudge` ([#533](https://github.com/absidue/YouTube.js/issues/533)) ([e021395](https://github.com/absidue/YouTube.js/commit/e02139532b2c07aaf72dd1bd8610f63b6780001d))
* Add `getCourses` ([#798](https://github.com/absidue/YouTube.js/issues/798)) ([cfb48fa](https://github.com/absidue/YouTube.js/commit/cfb48fab89792d87a7377eaf15a56d289d26769b))
* Add `MWEB` client ([4bf125b](https://github.com/absidue/YouTube.js/commit/4bf125b6a53460f631410e1ab949a16cc0c7d095))
* Add `TV_SIMPLY` client ([8cf6581](https://github.com/absidue/YouTube.js/commit/8cf658151fc4e4266fadfb7e53dd5db3db693355))
* Add `TVHTML5` InnerTube client ([b45609a](https://github.com/absidue/YouTube.js/commit/b45609aa0fcd801c379ffdafd04c6c3c2ed3deba))
* add `VideoAttributeView` ([#531](https://github.com/absidue/YouTube.js/issues/531)) ([ff4ab16](https://github.com/absidue/YouTube.js/commit/ff4ab1680e110fc32e09d09215fd3e05dbde2c85))
* add `VideoMetadataCarouselView` ([#839](https://github.com/absidue/YouTube.js/issues/839)) ([9a9bb76](https://github.com/absidue/YouTube.js/commit/9a9bb76a928594c5c5f3e828c86081bf79c2562d))
* Add `WEB_CREATOR` client ([#757](https://github.com/absidue/YouTube.js/issues/757)) ([dd7f5cf](https://github.com/absidue/YouTube.js/commit/dd7f5cf778b8acca95cc6d9c6e379e3e87e0ee8a))
* Add `WEB_EMBEDDED` client ([#756](https://github.com/absidue/YouTube.js/issues/756)) ([eaf218f](https://github.com/absidue/YouTube.js/commit/eaf218f5da758fc37d71f7d00ba9e42533194f8a))
* Add AccessibilityContext and CommandContext classes + improve type definitions and parsing logic across multiple nodes ([923e9c2](https://github.com/absidue/YouTube.js/commit/923e9c28e34b00841413824d82d10bf644186edc))
* Add Shorts endpoint ([#512](https://github.com/absidue/YouTube.js/issues/512)) ([a32aa8c](https://github.com/absidue/YouTube.js/commit/a32aa8c633b6f3c3bb0695ad1878cbb313867346))
* add support of cloudflare workers ([#596](https://github.com/absidue/YouTube.js/issues/596)) ([2029aec](https://github.com/absidue/YouTube.js/commit/2029aec90de3c0fdb022094d7b704a2feed4133b))
* **Channel:** Add `getCourses` method ([#883](https://github.com/absidue/YouTube.js/issues/883)) ([b3a4862](https://github.com/absidue/YouTube.js/commit/b3a48621518f09d1ce309071499d9626cc1a8488))
* **Channel:** Support getting about with PageHeader ([#581](https://github.com/absidue/YouTube.js/issues/581)) ([2e710dc](https://github.com/absidue/YouTube.js/commit/2e710dc9f7e206627f189df19be17009b270bc8b))
* **Channel:** Support new about popup ([#537](https://github.com/absidue/YouTube.js/issues/537)) ([c66eb1f](https://github.com/absidue/YouTube.js/commit/c66eb1fecf0e66d9eca841be0ca56b39ad4466eb))
* **Channel:** Support PageHeader being used on user channels ([#577](https://github.com/absidue/YouTube.js/issues/577)) ([6082b4a](https://github.com/absidue/YouTube.js/commit/6082b4a52ee07a622735e6e9128a0531a5ae3bfb))
* **CommentsView:** parse `voice_reply_transcript` ([#981](https://github.com/absidue/YouTube.js/issues/981)) ([d6f13e2](https://github.com/absidue/YouTube.js/commit/d6f13e20ac6806e7a97dc8c3bd6bb947be6fd76c))
* **CommentView:** Implement comment interaction methods ([1c08bfe](https://github.com/absidue/YouTube.js/commit/1c08bfe113804c69fbc4e49b42442d9a63d73be6))
* **CommentView:** Parse `prepareAccountCommand` ([d0d48bf](https://github.com/absidue/YouTube.js/commit/d0d48bf525cc2a95dd3397a3142bea113ea9782e))
* **CommentView:** Parse some extra tooltips ([32125c7](https://github.com/absidue/YouTube.js/commit/32125c704565f425806a0721edd96e01028e3fdd))
* **CompactLink:** Parse `subtitle`, `iconType`, and `iconType` ([6d57353](https://github.com/absidue/YouTube.js/commit/6d57353a8021430a5253e2fb2c974ca98d731791))
* **ContentMetadataView:** Parse `enableTruncation` ([#863](https://github.com/absidue/YouTube.js/issues/863)) ([0a3104b](https://github.com/absidue/YouTube.js/commit/0a3104bafc03ccd29420a835b420f628b380991d))
* **DashManifest:** Add DRM infos to MPD ([7ae4ccf](https://github.com/absidue/YouTube.js/commit/7ae4ccf70ad78bac7d6421d94df529f8f79a13f3))
* **EngagementPanelTitleHeader:** Add `contextual_info` and `menu` ([af3a916](https://github.com/absidue/YouTube.js/commit/af3a91645d84798e744519ec8f24e565cc1ecdb1))
* extend music getInfo to allow MusicResponsiveListItem and Nav Endpoints ([#751](https://github.com/absidue/YouTube.js/issues/751)) ([5db449c](https://github.com/absidue/YouTube.js/commit/5db449cc6d86b2df1e92302ec5c74e6d44d822fb))
* **Format:** Add `is_drc` ([#656](https://github.com/absidue/YouTube.js/issues/656)) ([6bb2086](https://github.com/absidue/YouTube.js/commit/6bb2086875d089f47c5f86ce94db9e32cb051319))
* **Format:** Add `is_secondary` for detecting secondary audio tracks ([#697](https://github.com/absidue/YouTube.js/issues/697)) ([a352dde](https://github.com/absidue/YouTube.js/commit/a352ddeb9db001e99f49025048ad0942d84f1b3e))
* **Format:** Add `max_dvr_duration_sec` and `target_duration_dec` ([#570](https://github.com/absidue/YouTube.js/issues/570)) ([586bb5f](https://github.com/absidue/YouTube.js/commit/586bb5f1398d68bfabfb9449f527e53c398c3767))
* **Format:** Add `projection_type` and `stereo_layout` ([#643](https://github.com/absidue/YouTube.js/issues/643)) ([064436c](https://github.com/absidue/YouTube.js/commit/064436cef30e892d8f569d4f7b146557fd72b09f))
* **Format:** Add `spatial_audio_type` ([#647](https://github.com/absidue/YouTube.js/issues/647)) ([0ba8c54](https://github.com/absidue/YouTube.js/commit/0ba8c54257b068d7e4518c982396acb42f1dd41d))
* **Format:** Support caption tracks in adaptive formats ([#598](https://github.com/absidue/YouTube.js/issues/598)) ([bff65f8](https://github.com/absidue/YouTube.js/commit/bff65f8889c32813ec05bd187f3a4386fc6127c0))
* **FormatUtils:** choose more specific format by itag or codec ([#884](https://github.com/absidue/YouTube.js/issues/884)) ([1c1577e](https://github.com/absidue/YouTube.js/commit/1c1577e85fd46cbfa15bcee6531d9aafdda787e5))
* **generator:** add support for arrays ([#556](https://github.com/absidue/YouTube.js/issues/556)) ([e4f2a00](https://github.com/absidue/YouTube.js/commit/e4f2a00c843fe453cc7904f79e35597cc6e2e619))
* **generator:** Add support for generating view models ([#550](https://github.com/absidue/YouTube.js/issues/550)) ([f938c34](https://github.com/absidue/YouTube.js/commit/f938c34ee81186774096b3d24d06250211ce2851))
* **getSearchSuggestions:** Add optional `pq` param for better suggestions ([c61db19](https://github.com/absidue/YouTube.js/commit/c61db19f2e3bd44bc5bf2ebdf8de041f169d8fab))
* **history:** Add ability to remove videos from watch history ([#706](https://github.com/absidue/YouTube.js/issues/706)) ([22dd71d](https://github.com/absidue/YouTube.js/commit/22dd71d7dad5029f2f7ed0deafbae3386ebe298d))
* **Innertube:** Add `getAttestationChallenge` ([#869](https://github.com/absidue/YouTube.js/issues/869)) ([33c27dd](https://github.com/absidue/YouTube.js/commit/33c27ddcb5ea96241b2a0bf4ec14ec5937264998))
* **Innertube:** Add `GetVideoInfoOptions` to support content bound PoTokens ([#994](https://github.com/absidue/YouTube.js/issues/994)) ([b6386e4](https://github.com/absidue/YouTube.js/commit/b6386e40274432591a9063059e8b688da0d26c38))
* **Innertube:** Add ability to get individual community posts and community post comments ([#861](https://github.com/absidue/YouTube.js/issues/861)) ([360b29e](https://github.com/absidue/YouTube.js/commit/360b29ee60af2cf803106ca5315c365ddacbe51b))
* **Kids:** Add `blockChannel` command to easily block channels ([#503](https://github.com/absidue/YouTube.js/issues/503)) ([9ab528e](https://github.com/absidue/YouTube.js/commit/9ab528ec823dcd527a97150009eed632c6d3eb6a))
* **LiveChatPaidMessage:** Parse `headerOverlayImage` and `lowerBumper` ([#851](https://github.com/absidue/YouTube.js/issues/851)) ([ef37aa0](https://github.com/absidue/YouTube.js/commit/ef37aa0a5abb573f192f86d1accb88d90d707752))
* **Log:** Convert Log class to module ([#814](https://github.com/absidue/YouTube.js/issues/814)) ([fc55716](https://github.com/absidue/YouTube.js/commit/fc5571629eca037af7de03f4b903da6add1f300b))
* **MediaInfo:** Add `updateWatchTime` ([#874](https://github.com/absidue/YouTube.js/issues/874)) ([065e9a4](https://github.com/absidue/YouTube.js/commit/065e9a4e7c3fee90f68d06992cf979338f8e3aba))
* **MediaInfo:** Parse player config ([5c9c231](https://github.com/absidue/YouTube.js/commit/5c9c231cc2f17c49da03daa8262043b985320e9a))
* **MultiPageMenuNotificationSection:** Add `notification_section_title` ([f869011](https://github.com/absidue/YouTube.js/commit/f8690118c3e4edbc22a6b9f59477a8e40e39d9a3))
* **music#getSearchSuggestions:** Return array of `SearchSuggestionsSection` instead of a single node ([beaa28f](https://github.com/absidue/YouTube.js/commit/beaa28f4c68de8366caa84ce5a026bf9e12e1b9d))
* **Music:** Add continuation support for "Up next" tab in `TrackInfo` ([#770](https://github.com/absidue/YouTube.js/issues/770)) ([2913d5f](https://github.com/absidue/YouTube.js/commit/2913d5f43dd28b9146cf05607cbe28d727463d51))
* **MusicImmersiveHeader:** Parse buttons and menu ([cbb2535](https://github.com/absidue/YouTube.js/commit/cbb2535b2492777b0045be5fcf9bece03fe4f84e))
* **NavigationEndpoint:** Add name property ([bdebb9f](https://github.com/absidue/YouTube.js/commit/bdebb9f741291d2f0640274454c90b5ccda8ea5d))
* **OAuth:** Allow passing custom client identity ([#566](https://github.com/absidue/YouTube.js/issues/566)) ([7ffd0fc](https://github.com/absidue/YouTube.js/commit/7ffd0fc25edef99a938e7986b1c74af05b8f954e))
* **PageHeaderView:** Parse `heroImage` ([a602a31](https://github.com/absidue/YouTube.js/commit/a602a317aaaffa575d2b03754f0625a6e5858162))
* **parser-classes:** Add `CompositeVideoPrimaryInfo` parser class ([#984](https://github.com/absidue/YouTube.js/issues/984)) ([6386976](https://github.com/absidue/YouTube.js/commit/638697696f54482c5270b0d11d1a7a33b5cd902a))
* **parser:** `Add AnimatedThumbnailOverlayView` ([#903](https://github.com/absidue/YouTube.js/issues/903)) ([0cb92d9](https://github.com/absidue/YouTube.js/commit/0cb92d9620c13bf6b719b384f917ad2a658e15b1))
* **parser:** Add `ActiveAccountHeader` ([5f233ae](https://github.com/absidue/YouTube.js/commit/5f233ae34e278e7f7a0c48e4ba762d9bac9e312f))
* **parser:** Add `AddToPlaylist` node ([2940f7b](https://github.com/absidue/YouTube.js/commit/2940f7b908ee720492994a41efdabb9fae08708c))
* **parser:** Add `animated_image` to `PageHeaderView` ([#819](https://github.com/absidue/YouTube.js/issues/819)) ([8e50ebd](https://github.com/absidue/YouTube.js/commit/8e50ebd92583ae76b080fed4c7599684370dc09d))
* **Parser:** Add `AvatarStackView` ([c631022](https://github.com/absidue/YouTube.js/commit/c6310228fee1ed01f93a0e4e0482d09a967ef1be))
* **parser:** Add `ButtonCardView` ([#834](https://github.com/absidue/YouTube.js/issues/834)) ([eeaae62](https://github.com/absidue/YouTube.js/commit/eeaae6209f238b838b9b7fdd9bbef89f4f858fa3))
* **parser:** Add `ChangeEngagementPanelVisibilityAction` ([c2b2d7a](https://github.com/absidue/YouTube.js/commit/c2b2d7ad52d2cdd1d721ae4569fb6f8cb0540476))
* **parser:** Add `ChangeEngagementPanelVisibilityEndpoint` ([2824900](https://github.com/absidue/YouTube.js/commit/28249008521b4cb600756f8ff83e10ec3037ba69))
* **parser:** Add `ChannelOwnerEmptyState` ([#541](https://github.com/absidue/YouTube.js/issues/541)) ([b60930a](https://github.com/absidue/YouTube.js/commit/b60930a0c1ce419dddb753846c84d4e46ddf04e1))
* **parser:** Add `ClientSideToggleMenuItem` ([#835](https://github.com/absidue/YouTube.js/issues/835)) ([0b2b0da](https://github.com/absidue/YouTube.js/commit/0b2b0da9577f8d6ad19393700071ea9f26d4da10))
* **Parser:** Add `ClipSection` ([#532](https://github.com/absidue/YouTube.js/issues/532)) ([9007b65](https://github.com/absidue/YouTube.js/commit/9007b652375e1ca3c3844bdf091fe3670f98dc2c))
* **Parser:** Add `DismissableDialog` and `DismissableDialogContentSection` nodes ([#997](https://github.com/absidue/YouTube.js/issues/997)) ([e94ef37](https://github.com/absidue/YouTube.js/commit/e94ef3748e6a38f192d79e5f12165933c6e6dc94))
* **parser:** Add `EomSettingsDisclaimer` node ([#703](https://github.com/absidue/YouTube.js/issues/703)) ([a9bf225](https://github.com/absidue/YouTube.js/commit/a9bf225a62108e47a50316235a83a814c682d745))
* **Parser:** Add `HowThisWasMadeSectionView` node ([5da8a66](https://github.com/absidue/YouTube.js/commit/5da8a66551c85fa45a01713383e6f621db053b46))
* **Parser:** Add `HypePointsFactoid` node ([0091f51](https://github.com/absidue/YouTube.js/commit/0091f51dd2691dd1031896dd52c989426534dae8))
* **parser:** Add `ImageBannerView` ([#583](https://github.com/absidue/YouTube.js/issues/583)) ([2073aa9](https://github.com/absidue/YouTube.js/commit/2073aa910a0e441a8ec1a9ba0434051ec0e2e6a9))
* **parser:** Add `LiveChatBannerChatSummary` node, update `TextRun` node ([#809](https://github.com/absidue/YouTube.js/issues/809)) ([7fb00fa](https://github.com/absidue/YouTube.js/commit/7fb00fa378574d1567d436f8a824fbb618db2373))
* **parser:** Add `LiveChatBannerRedirect` node ([#799](https://github.com/absidue/YouTube.js/issues/799)) ([ad302b8](https://github.com/absidue/YouTube.js/commit/ad302b8b17c0bfc1d81728130d4ba25a88ed241f))
* **parser:** add `LiveChatModeChangeMessage` node ([#811](https://github.com/absidue/YouTube.js/issues/811)) ([7156a58](https://github.com/absidue/YouTube.js/commit/7156a585c036a5000d0a50f3f4860a462762fdfe))
* **parser:** Add `LiveChatSponsorshipsGiftPurchaseAnnouncement` and `LiveChatSponsorshipsHeader` nodes ([#793](https://github.com/absidue/YouTube.js/issues/793)) ([4e9c2a5](https://github.com/absidue/YouTube.js/commit/4e9c2a585bf84751dd4e3964f70fba284c8b8e38))
* **parser:** Add `LiveChatSponsorshipsGiftRedemptionAnnouncement` node ([#795](https://github.com/absidue/YouTube.js/issues/795)) ([20f7971](https://github.com/absidue/YouTube.js/commit/20f797129973c6b91fa228e50d375b0c9d0226d2))
* **parser:** Add `MenuFlexibleItem` ([bc9a0ed](https://github.com/absidue/YouTube.js/commit/bc9a0ed6c1dd7aac280e0461823827d71ce0991f))
* **Parser:** Add `MusicResponsiveHeader` node ([ea82bea](https://github.com/absidue/YouTube.js/commit/ea82beaa10f6c877d6dd3102e10f6ae382560e0f))
* **parser:** Add `NotificationAction` node ([d36ddb8](https://github.com/absidue/YouTube.js/commit/d36ddb804a03b7d22cd20c2b846f86dd49689c0c))
* **Parser:** Add `OpenOnePickAddVideoModalCommand` node ([#901](https://github.com/absidue/YouTube.js/issues/901)) ([ff1aa67](https://github.com/absidue/YouTube.js/commit/ff1aa67b8bebd8e038ea77a124d0be0ed420bc55))
* **parser:** Add `PlayerOverflow` and `PlayerControlsOverlay` ([a45273f](https://github.com/absidue/YouTube.js/commit/a45273fec498df87eecd364ffb708c9f787793d5))
* **parser:** Add `PlayerOverlayVideoDetails` node ([dc2ed04](https://github.com/absidue/YouTube.js/commit/dc2ed046b8424134c675f30e7452fbd6bda0d228))
* **parser:** Add `PlaylistThumbnailOverlay` ([c8173c8](https://github.com/absidue/YouTube.js/commit/c8173c88e0e17ec4bb4e93af1867c55d07611cc0))
* **parser:** Add `ReplaceLiveChatAction` ([#847](https://github.com/absidue/YouTube.js/issues/847)) ([342fdd1](https://github.com/absidue/YouTube.js/commit/342fdd1db30bc61de5f19fc4ed35db8931706903))
* **parser:** Add `RunAttestationCommand` ([4729016](https://github.com/absidue/YouTube.js/commit/4729016fb98e7045ee4043857be7eef780c01e35))
* **Parser:** Add `SectionHeaderView` and `GridShelfView` ([#988](https://github.com/absidue/YouTube.js/issues/988)) ([bc386db](https://github.com/absidue/YouTube.js/commit/bc386db6bad4040580b85ce64a39a30d9a04cb38))
* **parser:** Add `ShortsLockupView` and `BadgeView` nodes ([#746](https://github.com/absidue/YouTube.js/issues/746)) ([e1e76ee](https://github.com/absidue/YouTube.js/commit/e1e76ee61629f84f4b7de9579ae9f6d6bf97bab8))
* **parser:** Add `ShowEngagementPanelEndpoint` ([ec85b0f](https://github.com/absidue/YouTube.js/commit/ec85b0f9421156c674c5c4d4a3a2e39eca7dbfbf))
* **parser:** Add `SignalAction` node ([feeb21b](https://github.com/absidue/YouTube.js/commit/feeb21b3ebb83772fcceb1f6b0a90c17db613451))
* **Parser:** Add `ToggleFormField` node ([#902](https://github.com/absidue/YouTube.js/issues/902)) ([42bcf19](https://github.com/absidue/YouTube.js/commit/42bcf197bc8b3117e40d8f61300a97332e4963ba))
* **parser:** Add `UnifiedSharePanel` ([4a1397f](https://github.com/absidue/YouTube.js/commit/4a1397f1bcc2ad9964626b11c90831b90989b6af))
* **parser:** Add `UpdateSubscribeButtonAction` ([fdb7540](https://github.com/absidue/YouTube.js/commit/fdb754043b809223ae8938fbbdd5780f585b697e))
* **parser:** Add `VideoAttributesSectionView` node ([#732](https://github.com/absidue/YouTube.js/issues/732)) ([4b60b97](https://github.com/absidue/YouTube.js/commit/4b60b97132b0ee42b41838f3336c582a7f7f7aec))
* **parser:** Add `VideoViewCount` node ([ad448f8](https://github.com/absidue/YouTube.js/commit/ad448f8106116e44e65eb5f5351c38fc4a31d809))
* **parser:** add classdata to unhandled parse errors ([#691](https://github.com/absidue/YouTube.js/issues/691)) ([090539b](https://github.com/absidue/YouTube.js/commit/090539b28f9bc3387d01e37325ba5741b33b1765))
* **parser:** Add mobile guide nodes ([ad2ae51](https://github.com/absidue/YouTube.js/commit/ad2ae51b97d84dcb9d2547b4cfef7402f2410404))
* **parser:** Add optional image property to LockupMetadataView ([#806](https://github.com/absidue/YouTube.js/issues/806)) ([0914299](https://github.com/absidue/YouTube.js/commit/091429921530d65daf8f5b281c7c54117ee9a474))
* **Parser:** add support for parsing subtitle for `RichShelf` ([#805](https://github.com/absidue/YouTube.js/issues/805)) ([038efff](https://github.com/absidue/YouTube.js/commit/038efff17f3b12d80619c8990ca880e919d2bfe5))
* **Parser:** Add support for parsing subtitle for `Shelf` ([#792](https://github.com/absidue/YouTube.js/issues/792)) ([34ae38c](https://github.com/absidue/YouTube.js/commit/34ae38cbf4aa0a42a6024fa99eb0fe553639c8ce))
* **Parser:** Implement utility class to parse `rendererContext` ([3a11b99](https://github.com/absidue/YouTube.js/commit/3a11b99429ff9d8cc9aebc7bbee0b7645e30f7ff))
* **parser:** Parse `OpenPopupAction` in `onResponseReceivedEndpoints` arrays ([45b7342](https://github.com/absidue/YouTube.js/commit/45b734288e070ef5e347cec5bae445d0cf883eba))
* **parser:** Parse `targetId` ([458c490](https://github.com/absidue/YouTube.js/commit/458c4900d78f9b16761faae421bcd8cb302f19b8))
* **Parser:** Parse YpcTrailer in VideoInfo ([#842](https://github.com/absidue/YouTube.js/issues/842)) ([c0043d0](https://github.com/absidue/YouTube.js/commit/c0043d0194f582c2ed85341291e2eace25dd78d8))
* **parser:** Support CommentView nodes ([#614](https://github.com/absidue/YouTube.js/issues/614)) ([900f557](https://github.com/absidue/YouTube.js/commit/900f5572021d348e7012909f2080e52eac06adae))
* **parser:** Support LockupView and it's child nodes ([#609](https://github.com/absidue/YouTube.js/issues/609)) ([7ca2a0c](https://github.com/absidue/YouTube.js/commit/7ca2a0c3e43ebd4b9443e69b7432f302b09e9c7a))
* **parser:** Support new like and dislike nodes ([#557](https://github.com/absidue/YouTube.js/issues/557)) ([fcd3044](https://github.com/absidue/YouTube.js/commit/fcd30449821763e9b5b57718dd02eff15d964d2b))
* **parser:** Update `Button` ([#857](https://github.com/absidue/YouTube.js/issues/857)) ([5f899fc](https://github.com/absidue/YouTube.js/commit/5f899fcdb30deefc189e8325e4358812c5b05800))
* **parser:** Update `LiveChatBanner` ([#840](https://github.com/absidue/YouTube.js/issues/840)) ([69d42b2](https://github.com/absidue/YouTube.js/commit/69d42b291c927abb9d84f97ed03518c4ddd4506e))
* **parser:** Update `LiveChatMembershipItem` ([#836](https://github.com/absidue/YouTube.js/issues/836)) ([0c319aa](https://github.com/absidue/YouTube.js/commit/0c319aacdeba106d84b7f44505a7a296a154f97a))
* **parser:** Update `LiveChatPaidMessage` ([#846](https://github.com/absidue/YouTube.js/issues/846)) ([73362c6](https://github.com/absidue/YouTube.js/commit/73362c68fbc8b966ff46cc8b145e1e8d9fbe32ee))
* **parser:** Update `LiveChatPaidSticker` ([#849](https://github.com/absidue/YouTube.js/issues/849)) ([3c28c0d](https://github.com/absidue/YouTube.js/commit/3c28c0d2c2b583a31fe0e49cce4cdfbfe380874d))
* **parser:** Update `LiveChatTextMessage` ([#864](https://github.com/absidue/YouTube.js/issues/864)) ([9025122](https://github.com/absidue/YouTube.js/commit/902512248417ae86e25082d429b13d8c57a5c5b1))
* **parser:** Update `LiveChatTickerPaidMessageItem` ([#845](https://github.com/absidue/YouTube.js/issues/845)) ([29e8d30](https://github.com/absidue/YouTube.js/commit/29e8d3015a3d17383a8be4e6f46b389d10f111f3))
* **parser:** Update `LiveChatTickerPaidStickerItem` ([#848](https://github.com/absidue/YouTube.js/issues/848)) ([5f83a74](https://github.com/absidue/YouTube.js/commit/5f83a7416d5dc3167e6af2767e9b90f4bf89f3dc))
* **parser:** Update `LiveChatViewerEngagementMessage` ([#856](https://github.com/absidue/YouTube.js/issues/856)) ([b4a947a](https://github.com/absidue/YouTube.js/commit/b4a947a9eb9dd1ae6e9d1da1a00083ac1afca03e))
* **Platform:** Add support for `react-native` platform ([#593](https://github.com/absidue/YouTube.js/issues/593)) ([2980a60](https://github.com/absidue/YouTube.js/commit/2980a608b67f18416d7f73f1bdbcf4b897307b26))
* **Player:** Add support for Proof of Identity tokens ([#708](https://github.com/absidue/YouTube.js/issues/708)) ([c9f0ddd](https://github.com/absidue/YouTube.js/commit/c9f0ddd573de297c0b384e422e6c1737454926e2))
* **PlaylistManager:** Add ability to remove videos by set ID ([#715](https://github.com/absidue/YouTube.js/issues/715)) ([d85fbc5](https://github.com/absidue/YouTube.js/commit/d85fbc56cf0fd7367b182ae36e65c1701bc5e62d))
* **Playlists:** Implement `addToLibrary` and `removeFromLibrary` ([#844](https://github.com/absidue/YouTube.js/issues/844)) ([48460e4](https://github.com/absidue/YouTube.js/commit/48460e4184bac0f6626550b80696f950f7626beb))
* **proto:** Add `comment_id` to commentSectionParams ([#693](https://github.com/absidue/YouTube.js/issues/693)) ([a5f6209](https://github.com/absidue/YouTube.js/commit/a5f62093a18705fc822abd86beaa81788b6535ce))
* **ProtoUtils:** Add support for creating NextParams ([#762](https://github.com/absidue/YouTube.js/issues/762)) ([910c979](https://github.com/absidue/YouTube.js/commit/910c9791e7aed9e28cd42f3bcf28b8b8d89edb21))
* **RichGrid:** Parse `targetId` ([e571ee2](https://github.com/absidue/YouTube.js/commit/e571ee2426c6003c1bc690cbf98b0ab72ebfaa10))
* **RichRenderers:** Parse more UI elements ([d8f731b](https://github.com/absidue/YouTube.js/commit/d8f731b2fa4b755324b0ef4ad68be45f735b29a9))
* **RichShelf:** Add `icon_type` property ([dce51cd](https://github.com/absidue/YouTube.js/commit/dce51cdc4abad21812ee9e7ba02885dffde35d3a))
* **Session:** Add `configInfo` to InnerTube context ([5a8fd3a](https://github.com/absidue/YouTube.js/commit/5a8fd3ad37bce1decad28ec3727453ddd430a561))
* **Session:** Add `deviceExperimentId` and `rolloutToken` to session data ([c704836](https://github.com/absidue/YouTube.js/commit/c7048368cc38a6a322c8006a4cfd208235d27caf))
* **Session:** Add `enable_session_cache` option ([#664](https://github.com/absidue/YouTube.js/issues/664)) ([7953296](https://github.com/absidue/YouTube.js/commit/795329658033652625d2d61b275ccf703573a437))
* **Session:** Add `retrieve_innertube_config` option ([#949](https://github.com/absidue/YouTube.js/issues/949)) ([4808d2e](https://github.com/absidue/YouTube.js/commit/4808d2e13a90710cdea2c72332deb7809d5fdbdd))
* **Session:** Add option to override Player ID ([#951](https://github.com/absidue/YouTube.js/issues/951)) ([5e665e8](https://github.com/absidue/YouTube.js/commit/5e665e8f0ba6e68d689b42be852ec20597c6b6a6))
* **Session:** Allow using a fixed user agent for InnerTube requests ([#876](https://github.com/absidue/YouTube.js/issues/876)) ([4d36655](https://github.com/absidue/YouTube.js/commit/4d36655b2dad74aeb74e869ca8259e9d13dfb512))
* **StreamingInfoOptions:** Add `is_sabr` option ([#974](https://github.com/absidue/YouTube.js/issues/974)) ([561e60b](https://github.com/absidue/YouTube.js/commit/561e60b934df29520eb0bd83a98e42fa4d7d35bb))
* **SubscribeButton:** Add `unsubscribe_text` ([75b8964](https://github.com/absidue/YouTube.js/commit/75b89641805abada1498edebac5b72a40860b215))
* **SubscribeButton:** Parse more endpoints ([8bf9eb7](https://github.com/absidue/YouTube.js/commit/8bf9eb7044ad9a5de0892207690195f5646df288))
* Support auto-dubbed audio tracks ([#786](https://github.com/absidue/YouTube.js/issues/786)) ([a4ef224](https://github.com/absidue/YouTube.js/commit/a4ef2249ffbe14f5d5fa702b269dd0f61e14ada8))
* **Text:** Parse accessibility data ([a95f52a](https://github.com/absidue/YouTube.js/commit/a95f52a4777ea158f3d3e85f4213aee364a2d38d))
* **Text:** Support formatting and emojis in `fromAttributed` ([#615](https://github.com/absidue/YouTube.js/issues/615)) ([e6f1f07](https://github.com/absidue/YouTube.js/commit/e6f1f078a828f8ea5db1fe7aec9f677bc53694e3))
* **Thumbnail:** Support `sources` in `Thumbnail.fromResponse` ([#552](https://github.com/absidue/YouTube.js/issues/552)) ([48a5d4e](https://github.com/absidue/YouTube.js/commit/48a5d4e7c37b76f8980f9b68e8815aef7a6d91ab))
* **toDash:** Add `contentType` to audio and video adaption sets ([#539](https://github.com/absidue/YouTube.js/issues/539)) ([4806fc6](https://github.com/absidue/YouTube.js/commit/4806fc6c112cb3cf0584f7d253f3c4aeaffa9927))
* **toDash:** Add option to include WebVTT or TTML captions ([#673](https://github.com/absidue/YouTube.js/issues/673)) ([bd9f6ac](https://github.com/absidue/YouTube.js/commit/bd9f6ac64ca9ba96e856aabe5fcc175fd9c294dc))
* **toDash:** Add support for generating manifests for Post Live DVR videos ([#580](https://github.com/absidue/YouTube.js/issues/580)) ([6dd03e1](https://github.com/absidue/YouTube.js/commit/6dd03e1658036c2fba0696de81033b5e16abb379))
* **toDash:** Add support for stable volume/DRC ([#662](https://github.com/absidue/YouTube.js/issues/662)) ([031ffb6](https://github.com/absidue/YouTube.js/commit/031ffb696e3b7e160779e8b55a49b0cfa9f95620))
* **toDash:** Add the "dub" role to translated captions ([#677](https://github.com/absidue/YouTube.js/issues/677)) ([858cdd1](https://github.com/absidue/YouTube.js/commit/858cdd197cb2bb1e1d7a7285966cb56043ad8961))
* **ToggleButtonView:** Add `is_toggled` ([88af6d8](https://github.com/absidue/YouTube.js/commit/88af6d89a56907d6f2263c01fc158400788fb5b4))
* **UpdateViewerShipAction:** Add `original_view_count` and `unlabeled_view_count_value` ([#527](https://github.com/absidue/YouTube.js/issues/527)) ([bc97e07](https://github.com/absidue/YouTube.js/commit/bc97e07ac6d1cdc45194e214c6001cf92190e1d5))
* Use `overrides` instead of `--legacy-peer-deps` ([#529](https://github.com/absidue/YouTube.js/issues/529)) ([db7f620](https://github.com/absidue/YouTube.js/commit/db7f6209b2329bf18b8b35aababfdb9b750c3b0f))
* **Utils:** Add `UMP` parser ([261f2ac](https://github.com/absidue/YouTube.js/commit/261f2ac12b6a9a5bd5f7a43557018de333f7bec3))
* **VideoDetails:** Add `is_live_dvr_enabled`, `is_low_latency_live_stream` and `live_chunk_readahead` ([#569](https://github.com/absidue/YouTube.js/issues/569)) ([254f779](https://github.com/absidue/YouTube.js/commit/254f77944fcd398cc19cb62b82b0fdfbe6ed70ed))
* **VideoInfo:** Add live stream `end_timestamp` ([#571](https://github.com/absidue/YouTube.js/issues/571)) ([562e6a2](https://github.com/absidue/YouTube.js/commit/562e6a20f06ef5302af427861355215630d91edc))
* **VideoInfo:** implement `MacroMarkersListEntity` parser for heatmap ([#973](https://github.com/absidue/YouTube.js/issues/973)) ([876e94a](https://github.com/absidue/YouTube.js/commit/876e94ad03398f546ef7942deb9ba5eb8baa6c6d))
* **VideoViewCount:** Add `extra_short_view_count` field ([d10fe68](https://github.com/absidue/YouTube.js/commit/d10fe6834a0d063d94b65289d54a52ed3398eff4))
* **YouTube:** Add FEchannels feed ([#560](https://github.com/absidue/YouTube.js/issues/560)) ([14578ac](https://github.com/absidue/YouTube.js/commit/14578ac96af4b8bee652cce87d043173de964113))


### Bug Fixes

* add missing `TV_SIMPLY` parts on some files ([#975](https://github.com/absidue/YouTube.js/issues/975)) ([689fb0b](https://github.com/absidue/YouTube.js/commit/689fb0b90edab6f0e4326a35144541d68f72fe01))
* **Artist:** `getAllSongs` not finding target shelf ([#999](https://github.com/absidue/YouTube.js/issues/999)) ([64f9955](https://github.com/absidue/YouTube.js/commit/64f995585fd0ee908bdc5404929996e9a5e5c3c9))
* **build:** Circular imports causing issues with webpack ([81dd5d3](https://github.com/absidue/YouTube.js/commit/81dd5d3288771132e7fb904b620e58277f639ccc))
* **build:** Inline package.json import to avoid runtime erros ([#509](https://github.com/absidue/YouTube.js/issues/509)) ([4c0de19](https://github.com/absidue/YouTube.js/commit/4c0de199e85dd5cc8b3719920b24dec9613acaab))
* **ButtonCardView:** Correct typo ([#855](https://github.com/absidue/YouTube.js/issues/855)) ([6536801](https://github.com/absidue/YouTube.js/commit/6536801ec2e4f9b93d1e272b7b04e2777b74abad))
* **ButtonView:** Rename `type` property to `button_type` ([15f3b5f](https://github.com/absidue/YouTube.js/commit/15f3b5fdba17f11cddada168de268546875e48f9))
* **Cache:** handle the value read from the db correctly according to its type ([#620](https://github.com/absidue/YouTube.js/issues/620)) ([3170659](https://github.com/absidue/YouTube.js/commit/317065988007c860bf6173b0ac3c3d685ed81d20))
* **Cache:** Use `TextEncoder` to encode compressed data ([384b80e](https://github.com/absidue/YouTube.js/commit/384b80ee41d7547a00d8dc17c50c8542629264b5))
* **Channel:** Remove `getChannels()` and `has_channels`, as YouTube removed the tab ([#542](https://github.com/absidue/YouTube.js/issues/542)) ([6a5a579](https://github.com/absidue/YouTube.js/commit/6a5a579e3947109af0e7c2a318aef40edb8484f8))
* **Channel:** Use new URL for community tab ([#986](https://github.com/absidue/YouTube.js/issues/986)) ([dfaf150](https://github.com/absidue/YouTube.js/commit/dfaf1501c93e29bd27a5553df0ee5b46d490ac12))
* **CommentThread:** Replies not being parsed correctly ([66e34f9](https://github.com/absidue/YouTube.js/commit/66e34f9388429a2088d5c5835d19eebdc881c957))
* **Constants:** Add `TVHTML5_SIMPLY` to `CLIENT_NAME_IDS` ([b15f623](https://github.com/absidue/YouTube.js/commit/b15f623dab3acb44eaef33175df2d22d35be2979))
* **Constants:** Update the iOS client version ([#924](https://github.com/absidue/YouTube.js/issues/924)) ([219d88b](https://github.com/absidue/YouTube.js/commit/219d88b2005431c6697f04e1fa2c5e8528a9ce57))
* **DecoratedAvatarView:** Fix parsing and optional properties ([#584](https://github.com/absidue/YouTube.js/issues/584)) ([fed3512](https://github.com/absidue/YouTube.js/commit/fed3512461277b7fc41e26c770e2bd3d4a7d5eb5))
* **dependencies:** Update `jintr` to version 3.2.1 ([02dfcae](https://github.com/absidue/YouTube.js/commit/02dfcae612dd528ce4f1f3f6c62ceefd02a5c790))
* **DescriptionPreviewView:** Parsing errors when certain fields are missing ([c2dd803](https://github.com/absidue/YouTube.js/commit/c2dd803eeaeec3292d92bc0efaaa2404fb87355c))
* **DialogView:** Type mismatch ([#897](https://github.com/absidue/YouTube.js/issues/897)) ([b731db8](https://github.com/absidue/YouTube.js/commit/b731db86c51ba292c848272f28b5a9aa2e2a6956))
* **examples:** Use BgUtils to generate pot [skip ci] ([d89909a](https://github.com/absidue/YouTube.js/commit/d89909a19a1486bee7e3275014725b4e3dc2cbe2))
* **ExpandableVideoDescriptionBody:** Parse attributed description ([360580e](https://github.com/absidue/YouTube.js/commit/360580ea6ea6fbdd7fbc0aa038d96b17de17e4f4))
* **Feed:** Do not throw when multiple continuations are present ([8e372d5](https://github.com/absidue/YouTube.js/commit/8e372d5c67f148be288bb0485f2c70ec43fbecd0))
* fix deno usage of protobuf and jintr ([#776](https://github.com/absidue/YouTube.js/issues/776)) ([02513b7](https://github.com/absidue/YouTube.js/commit/02513b76ed66041044e80f8749df7f29379c424e))
* **FlexibleActionsView:** Update actions array type to include `ToggleButtonView` ([040a091](https://github.com/absidue/YouTube.js/commit/040a09163903b914f546d5083dbfdeab7175b24c))
* **Format:** Extract correct audio language from captions ([#553](https://github.com/absidue/YouTube.js/issues/553)) ([5c83e99](https://github.com/absidue/YouTube.js/commit/5c83e999dfa00386d18369f42aa9aa10123ba578))
* **FormatOptions:** `client` missing some values ([fcd00b0](https://github.com/absidue/YouTube.js/commit/fcd00b0fb0f88a16c27da1ed89e9a2c4887e5c52))
* **Format:** Parse xtags from protobuf to support SABR-only responses ([#909](https://github.com/absidue/YouTube.js/issues/909)) ([00c199a](https://github.com/absidue/YouTube.js/commit/00c199ac69bc6d7be19aeae04a245f30b64272c2))
* **FormatUtils:** itag matching ([#886](https://github.com/absidue/YouTube.js/issues/886)) ([774b3a7](https://github.com/absidue/YouTube.js/commit/774b3a75244db85ceb7b00f658dc2dfeb2eb4e7e))
* **FormatUtils:** Throw an error if download requests fails ([a19511d](https://github.com/absidue/YouTube.js/commit/a19511de24bb82007aab072844efe64bbb8698da))
* **generator:** Output Parser.parseItem() calls with one valid type, without the array ([#551](https://github.com/absidue/YouTube.js/issues/551)) ([bd487f8](https://github.com/absidue/YouTube.js/commit/bd487f8befe7f62022c61ff3aae7f487104e81eb))
* **getBasicInfo:** Add racyCheckOk and contentCheckOk to payload ([#961](https://github.com/absidue/YouTube.js/issues/961)) ([0f1fd72](https://github.com/absidue/YouTube.js/commit/0f1fd7223c2e5c8e28637e84a1c00c6d88fad50f))
* **getSearchSuggestions:** Allow empty queries ([523700b](https://github.com/absidue/YouTube.js/commit/523700b728e8b2f126b1b6266dc153ad683dcbcb))
* Handle CommandExecutorCommand in NavigationEndpoint.call ([#968](https://github.com/absidue/YouTube.js/issues/968)) ([698121a](https://github.com/absidue/YouTube.js/commit/698121ab8f62fbed6e78892277caf93a9890b930))
* **HTTPClient:** Adjust more context fields for the iOS client ([#705](https://github.com/absidue/YouTube.js/issues/705)) ([3153375](https://github.com/absidue/YouTube.js/commit/3153375bcaa6c03afba9da8474e6a9d37471ed29))
* **HTTPClient:** Use the correct constant for the iOS client OS name ([#938](https://github.com/absidue/YouTube.js/issues/938)) ([95d9211](https://github.com/absidue/YouTube.js/commit/95d9211eae51c2d47468cacbed8cd9bdaa2fcd33))
* Include jinter in the cjs build ([305a398](https://github.com/absidue/YouTube.js/commit/305a398158a6cac82e6ef288fed4bf1661c89d52))
* **InfoPanelContainer:** Use new attributed text prop ([5cdb9e1](https://github.com/absidue/YouTube.js/commit/5cdb9e1e2fa4ad5abdb3659bb35d0b3edc60123c))
* **InfoPanelContent:** Update InfoPanelContent node to also support `paragraphs` ([4cbaa79](https://github.com/absidue/YouTube.js/commit/4cbaa7983f35a82b9907197769672ac3b300bfbe))
* **Innertube#getPost:** Update protobuf schema ([#987](https://github.com/absidue/YouTube.js/issues/987)) ([e9d6483](https://github.com/absidue/YouTube.js/commit/e9d6483e5a3c53efab6e29083e32f9a2e238bedc))
* **innertube:** Allowing `getStreamingData` to use client ([#895](https://github.com/absidue/YouTube.js/issues/895)) ([5aecd0a](https://github.com/absidue/YouTube.js/commit/5aecd0ace96c371f0b15cdc6e45ef09beb5696af))
* **Innertube:** Handle redirects in getChannel() ([#1002](https://github.com/absidue/YouTube.js/issues/1002)) ([cb87cc1](https://github.com/absidue/YouTube.js/commit/cb87cc1cae43b75ea31f984a9c6939097d58dd6f))
* **Innertube:** Properly encoded params in getPost() ([#882](https://github.com/absidue/YouTube.js/issues/882)) ([7d5c972](https://github.com/absidue/YouTube.js/commit/7d5c972c98d7c69b0b687b241c652f3098907a9f))
* **Innertube:** Properly encoded params in getPostComments() ([#955](https://github.com/absidue/YouTube.js/issues/955)) ([92b8623](https://github.com/absidue/YouTube.js/commit/92b8623374a126d60604a54fa4be67b460ddc5e3))
* **InteractionManager:** Use `WEB` for all actions ([d9ac99d](https://github.com/absidue/YouTube.js/commit/d9ac99d3324c2987aebb6b8e40317780478b7c19))
* **ItemSection:** FeedFilterChipBar parse error ([#741](https://github.com/absidue/YouTube.js/issues/741)) ([bf6cc00](https://github.com/absidue/YouTube.js/commit/bf6cc006997675010db61fcd776244b234be5611))
* **ItemSection:** Fix `target_id` not being set because of a typo. ([#655](https://github.com/absidue/YouTube.js/issues/655)) ([8106654](https://github.com/absidue/YouTube.js/commit/810665407e91b2890a8e555fd759d67ccd800379))
* **Library:** Add support for the new layout and remove profile & stats info ([4261915](https://github.com/absidue/YouTube.js/commit/4261915fd4aa84f7619a45d678910be0ae30e13e))
* **LiveChat#sendMessage:** Switch to `WEB` client ([bb3f114](https://github.com/absidue/YouTube.js/commit/bb3f114aa34dd50602da794dcb3aa3f28a5a2ed9))
* **LiveChatTextMessage:** Make some fields optional ([#877](https://github.com/absidue/YouTube.js/issues/877)) ([a035b71](https://github.com/absidue/YouTube.js/commit/a035b7169614ac92081b8cb377711d7da559e65b))
* **LockupMetadataView:** Parse `menuButton` ([3ffdee9](https://github.com/absidue/YouTube.js/commit/3ffdee9554b06db137d93e43b33fac124becf31f))
* **LockupView:** Add overlay nodes used by `VIDEO` views ([424c653](https://github.com/absidue/YouTube.js/commit/424c65356c24d19a921e24aadcbbb3cd03ab103a))
* **LockupView:** Fix `content_image` parsing ([083aec1](https://github.com/absidue/YouTube.js/commit/083aec1c805cce6b04a75e4f017b5cdf0bb6108e))
* Make "deno" conditional export have higher precedence than "node" ([#983](https://github.com/absidue/YouTube.js/issues/983)) ([2996ebb](https://github.com/absidue/YouTube.js/commit/2996ebb334d98cfde72243c233366285db945d02))
* **MediaInfo:** Remove unused parameters from `toDash` method ([3fcf987](https://github.com/absidue/YouTube.js/commit/3fcf987aecbb43ed16aa4d29a2d66c3c4ef15175))
* **music#getPlaylist:** Handle `ContinuationItem` nodes ([a3fafe2](https://github.com/absidue/YouTube.js/commit/a3fafe2f7979313906dbaf1a7f9779f411266d6b)), closes [#904](https://github.com/absidue/YouTube.js/issues/904)
* **MusicResponsiveHeader:** Add `Text` import ([583fd9f](https://github.com/absidue/YouTube.js/commit/583fd9f8d70735d071b34bd1d68faa62eeac593a))
* **package:** Use `jsr:@luanrt/jintr` on Deno ([d9ec23c](https://github.com/absidue/YouTube.js/commit/d9ec23c73ca4f370df45926206a2ff070bb6552f))
* **Parser:** Add `SortFilterHeader` ([#563](https://github.com/absidue/YouTube.js/issues/563)) ([8f07e49](https://github.com/absidue/YouTube.js/commit/8f07e49512c59eb72debc80a9d9623ca62330858))
* **Parser:** Add `UpdateEngagementPanelContentCommand` ([3f960ef](https://github.com/absidue/YouTube.js/commit/3f960effa24c3b14fa3c6aadf4c7badf0ac965c9))
* **parser:** Fix ShortsLockupView assuming that the primary text always exists ([#775](https://github.com/absidue/YouTube.js/issues/775)) ([43cef9e](https://github.com/absidue/YouTube.js/commit/43cef9e67e9defbfc498b6381ae93f967622f83b))
* **parser:** ignore MiniGameCardView node ([#692](https://github.com/absidue/YouTube.js/issues/692)) ([6d0bc89](https://github.com/absidue/YouTube.js/commit/6d0bc89be18f27a8ce74517f5cab5020d6790328))
* **parser:** The AvatarView.image_processor property is optional ([#807](https://github.com/absidue/YouTube.js/issues/807)) ([4b178e4](https://github.com/absidue/YouTube.js/commit/4b178e4bfbc4cb003ed098afcd0370f98dbf834b))
* **parser:** The icon_name property does not always exist in ThumbnailBadgeView ([#745](https://github.com/absidue/YouTube.js/issues/745)) ([094a96f](https://github.com/absidue/YouTube.js/commit/094a96fb5d8170d1f727ef6da84b258596b1a09a))
* **parser:** ThumbnailView background color ([#686](https://github.com/absidue/YouTube.js/issues/686)) ([0f8f92a](https://github.com/absidue/YouTube.js/commit/0f8f92a28a5b6143e890626b22ce570730a0cf09))
* **parser:** Update list of possible content_type in LockupView ([#808](https://github.com/absidue/YouTube.js/issues/808)) ([680da9f](https://github.com/absidue/YouTube.js/commit/680da9f501db02a9bed2fa8357df021e63024e5f))
* **Player:** Add more ways to find the nsig algo ([acfb0c5](https://github.com/absidue/YouTube.js/commit/acfb0c58bec25782aa92963cd590a56967229d62))
* **Player:** Bump cache version ([283172f](https://github.com/absidue/YouTube.js/commit/283172f22032d60b407cb0159a391a147b569432))
* **Player:** Bump cache version ([#702](https://github.com/absidue/YouTube.js/issues/702)) ([6765f4e](https://github.com/absidue/YouTube.js/commit/6765f4e0d791c657fc7411e9cdd2c0f9284e9982))
* **PlayerCaptionTracklist:** Fix `captions_tracks[].kind` type ([#586](https://github.com/absidue/YouTube.js/issues/586)) ([7fbc37f](https://github.com/absidue/YouTube.js/commit/7fbc37f9d1c109e448085d5736326dce82ca2c9a))
* **PlayerEndpoint:** Don't set `undefined` fields ([0e91a08](https://github.com/absidue/YouTube.js/commit/0e91a08ae2194a07defc4b1e12ff3edbe13b72df))
* **PlayerEndpoint:** Workaround for "The following content is not available on this app" (Android) ([#624](https://github.com/absidue/YouTube.js/issues/624)) ([d589365](https://github.com/absidue/YouTube.js/commit/d589365ea27f540ff36e33a65362c932cd28c274))
* **Player:** Fix extracting the n-token decipher algorithm ([#682](https://github.com/absidue/YouTube.js/issues/682)) ([142a7d0](https://github.com/absidue/YouTube.js/commit/142a7d042885188605bdc0655d3733502d1e20fa))
* **Player:** Fix extracting the n-token decipher algorithm again ([#701](https://github.com/absidue/YouTube.js/issues/701)) ([3048f70](https://github.com/absidue/YouTube.js/commit/3048f70f60756884bd7b591d770f7b6343cfa259))
* **Player:** Fix signature algorithm extraction ([#832](https://github.com/absidue/YouTube.js/issues/832)) ([ce4996c](https://github.com/absidue/YouTube.js/commit/ce4996cea7b0607cb7f9aca7ae9c9e439d964a5a))
* **Player:** Fix signature algorithm extraction again ([#837](https://github.com/absidue/YouTube.js/issues/837)) ([13e7961](https://github.com/absidue/YouTube.js/commit/13e796123b87136f2d5d3b3c9b3ed079a014bf46))
* **Player:** Parse global variable used by nsig/sig ([#935](https://github.com/absidue/YouTube.js/issues/935)) ([edfd65f](https://github.com/absidue/YouTube.js/commit/edfd65f5e08a9155b8c31d8127a4e309313b39de))
* **Player:** Use global var to find signature algorithm ([#953](https://github.com/absidue/YouTube.js/issues/953)) ([7f1eeb6](https://github.com/absidue/YouTube.js/commit/7f1eeb6b5bbae72d455609e8fd972ad936a69e27))
* **Playlist:** `items` getter failing if a playlist contains Shorts ([89fa3b2](https://github.com/absidue/YouTube.js/commit/89fa3b27a839d98aaf8bd70dd75220ee309c2bea))
* **PlaylistAddToOption:** Use correct type for `contains_selected_videos` ([53d1c75](https://github.com/absidue/YouTube.js/commit/53d1c759b65ce9b6cb9f236c02828077d4f506cc))
* **Playlist:** is_editable ([#894](https://github.com/absidue/YouTube.js/issues/894)) ([2b42199](https://github.com/absidue/YouTube.js/commit/2b4219959cbbb27cd80788e66b608fdeed3a1f1e))
* **Playlist:** Throw a more helpful error when parsing empty responses ([987f506](https://github.com/absidue/YouTube.js/commit/987f50604a0163f9a07091ce787995c6f6fddb75))
* **proto:** Fix visitor data base64url decoding ([#576](https://github.com/absidue/YouTube.js/issues/576)) ([3980f97](https://github.com/absidue/YouTube.js/commit/3980f97b8fca05f95cda1ab347db9402c55b8b3c))
* **proto:** Update `Context` message ([62ac2f6](https://github.com/absidue/YouTube.js/commit/62ac2f6f32d35fec3c31b5f5d556bd4569fa49f9)), closes [#681](https://github.com/absidue/YouTube.js/issues/681)
* **ReelPlayerOverlay:** Update `subscribe_button_renderer` type to include SubscribeButton ([daa5a29](https://github.com/absidue/YouTube.js/commit/daa5a2982b24f107681050f2b534986b4d374c5d))
* **Search:** Fix it occasionally returning only a small number of results ([#720](https://github.com/absidue/YouTube.js/issues/720)) ([2c0bb23](https://github.com/absidue/YouTube.js/commit/2c0bb237e1d0eb160dc3f879f5cab2022d9b5b04))
* **sendMessage:** Handle `RunAttestationCommand` in response actions ([#859](https://github.com/absidue/YouTube.js/issues/859)) ([826a954](https://github.com/absidue/YouTube.js/commit/826a9541a44121bafe4ce19f2cd4a68fcabb2384))
* **Session:** `PoToken` not being set correctly ([#729](https://github.com/absidue/YouTube.js/issues/729)) ([bb6e647](https://github.com/absidue/YouTube.js/commit/bb6e647b8c88753669acde43d0d648aaf11caba6))
* **Session:** Don't try to extract api version from service worker ([2068dfb](https://github.com/absidue/YouTube.js/commit/2068dfb73eefc0e40157421d4e5b4096c0c8429c))
* **Session:** Fix remote visitor data not gettting used ([#731](https://github.com/absidue/YouTube.js/issues/731)) ([7afc3da](https://github.com/absidue/YouTube.js/commit/7afc3da80ee3b5aa6edd2a899be82c1a21e03556))
* **Session:** Incorrect session client logic ([76504c0](https://github.com/absidue/YouTube.js/commit/76504c0d0875228299dddf24bd550ed2a5e4244f))
* **Session:** Initialize client version based on provided client name ([#971](https://github.com/absidue/YouTube.js/issues/971)) ([bb022e8](https://github.com/absidue/YouTube.js/commit/bb022e8285e0bf2dfa709e7401b80f9de18833e1))
* **Session:** Round UTC offset minutes ([84f90aa](https://github.com/absidue/YouTube.js/commit/84f90aaf2908ecacb9dfb6ce5497c4c4d14a72c3))
* **Session:** Set default values for `hl` and `gl` in context builder ([7a39326](https://github.com/absidue/YouTube.js/commit/7a3932682112a0d76c04f65ae35445fc35403a00))
* **Session:** Visitor data not being used properly ([f1973c1](https://github.com/absidue/YouTube.js/commit/f1973c11d9a492898b5e72b1f2b79291b674e229))
* **SignalAction:** Rename `action` to `signal` ([8ab760e](https://github.com/absidue/YouTube.js/commit/8ab760ea2e268a4f108b2b4a8d46193f5450bf4c))
* **StructuredDescriptionContent:** Add `ReelShelf` to list of possible nodes ([f74ed5a](https://github.com/absidue/YouTube.js/commit/f74ed5a1cf352a7b57fa84b9373f9ed9ba1911fc))
* **SubscribeButton:** Parse endpoints using `NavigationEndpoint` ([126a66f](https://github.com/absidue/YouTube.js/commit/126a66f317da0c6b486202ad04483b9799bfaf4c))
* **Text#fromAttributed:** Fix `StyleRun` assuming that the `startIndex` and `length` always exist ([#862](https://github.com/absidue/YouTube.js/issues/862)) ([732a30c](https://github.com/absidue/YouTube.js/commit/732a30c09f50a9d78d5d1686ffef88a3bde2e53e))
* **Text#toHTML:** Return empty string if the text is `undefined` ([f3c777b](https://github.com/absidue/YouTube.js/commit/f3c777b31638cc9c6ce7f4b7ba566ff0534b47dc))
* **TextRun:** Add `img` element only if an URL is available ([913dcc7](https://github.com/absidue/YouTube.js/commit/913dcc74eadf1a5df7878688d2c6cf434642f1b5))
* **ThumbnailOverlayResumePlayback:** Update `percent_duration_watched` type ([#737](https://github.com/absidue/YouTube.js/issues/737)) ([f9ccba4](https://github.com/absidue/YouTube.js/commit/f9ccba4af5268d67d8610a1a5d623964f56d170d))
* **toDash:** Add missing transfer characteristics for h264 streams ([#573](https://github.com/absidue/YouTube.js/issues/573)) ([59f4cfb](https://github.com/absidue/YouTube.js/commit/59f4cfb4db6184d47f0a6634832055e9ce71f644))
* **toDash:** Add missing transfer characteristics for h264 streams ([#631](https://github.com/absidue/YouTube.js/issues/631)) ([0107049](https://github.com/absidue/YouTube.js/commit/010704929fa4b737f68a5a1f10bf0b166cfbf905))
* **toDash:** Fix dash.js 4.x compatibility ([#765](https://github.com/absidue/YouTube.js/issues/765)) ([5ff30e1](https://github.com/absidue/YouTube.js/commit/5ff30e12ded29afff5a758cbe96ac3418e6d20aa))
* **toDash:** Fix default audio stream for dubbed movie trailers ([#858](https://github.com/absidue/YouTube.js/issues/858)) ([0054690](https://github.com/absidue/YouTube.js/commit/00546909c02841c7e404766b13f2c02e42e3f6fc))
* **toDash:** Fix image representations not being spec compliant ([#672](https://github.com/absidue/YouTube.js/issues/672)) ([e5aab9a](https://github.com/absidue/YouTube.js/commit/e5aab9a9b35f0752cd5ca50bfa25936dce4718c6))
* **UnifiedSharePanel:** Check if `thirdPartyNetworkSection` exists ([d3f6af0](https://github.com/absidue/YouTube.js/commit/d3f6af07754f75c578dc11e8ea4815ad91f0cac4))
* **VideoAttributeView:** Fix `image` and `overflow_menu_on_tap` props ([5ae15be](https://github.com/absidue/YouTube.js/commit/5ae15be63dee2a2393a1aa2a308ca5378140760a))
* **VideoAttributeView:** Parse `secondarySubtitle` only if exists ([0a99342](https://github.com/absidue/YouTube.js/commit/0a99342ccbd6f8b1c611ef6b157a599ff5ae2247))
* **VideoCard:** fix parsing author, view count and published date ([#791](https://github.com/absidue/YouTube.js/issues/791)) ([a4394db](https://github.com/absidue/YouTube.js/commit/a4394dbb82203eeabcb8684ca9105f83e3b0fb1b))
* **VideoInfo:** Fix error because of typo in getWatchNextContinuation ([#590](https://github.com/absidue/YouTube.js/issues/590)) ([b21eb9f](https://github.com/absidue/YouTube.js/commit/b21eb9f33d956e130bac98712384125ae04ace47))
* **VideoInfo:** Fix like count being undefined ([#787](https://github.com/absidue/YouTube.js/issues/787)) ([182bf42](https://github.com/absidue/YouTube.js/commit/182bf42d3cdf5148c667e958cd4d4eaa091a6d68))
* **VideoInfo:** Restore `like`, `dislike` & `removeRating` methods ([9c503f4](https://github.com/absidue/YouTube.js/commit/9c503f4fa8a750558cedbeca974faf36e304147e))
* **VideoSecondaryInfo:** Parse `show_more_text` and `show_less_text` correctly ([790f817](https://github.com/absidue/YouTube.js/commit/790f8172fc2bbdbf17f16b04a2676fd9088d8878))
* **YTMusic:** Add support for new header layouts ([14c3a06](https://github.com/absidue/YouTube.js/commit/14c3a06d402989e98a9d32c79b2dc26f74fb0219))


### Performance Improvements

* **constants:** Move the client name IDs into their own CLIENT_NAME_IDS object ([#875](https://github.com/absidue/YouTube.js/issues/875)) ([06887e9](https://github.com/absidue/YouTube.js/commit/06887e99fb1c2546e74b5026cb1ae1ce0be2e3e9))
* **general:** Add session cache and LZW compression ([#663](https://github.com/absidue/YouTube.js/issues/663)) ([cf29664](https://github.com/absidue/YouTube.js/commit/cf29664d376ff792602400ef9a4ac301c676735c))
* Optimise DASH manifest generation ([#870](https://github.com/absidue/YouTube.js/issues/870)) ([1a3d663](https://github.com/absidue/YouTube.js/commit/1a3d663cc56a54b8517eb5f82e7892d37db3082e))
* Use named Parser import, to allow bundlers to create direct function references ([#535](https://github.com/absidue/YouTube.js/issues/535)) ([95ed602](https://github.com/absidue/YouTube.js/commit/95ed60207a1219f4891f28d2b2b90cf816f11831))


### Reverts

* "fix(toDash): Fix default audio stream for dubbed movie trailers ([#858](https://github.com/absidue/YouTube.js/issues/858))" ([#896](https://github.com/absidue/YouTube.js/issues/896)) ([4325717](https://github.com/absidue/YouTube.js/commit/432571769ebc6634c2c9a4c1b5e53cfbbd2a5f0a))


### Miscellaneous Chores

* **parser:** Remove getters that have been deprecated for a long time ([#815](https://github.com/absidue/YouTube.js/issues/815)) ([9cf0d3f](https://github.com/absidue/YouTube.js/commit/9cf0d3f3b3099af3dd59bc4ca99fefe217a91020))


### Code Refactoring

* Deprecate `account#getAnalytics`, `account#getTimeWatched` and `account#getAnalytics` ([0081e11](https://github.com/absidue/YouTube.js/commit/0081e11ebcff8c719902d93edf8760d3e8702e00))
* Drop support for CommonJS ([d134fd2](https://github.com/absidue/YouTube.js/commit/d134fd2e9e1b27aebd1095562cd5c5da32cbf6d8))
* **Innertube#getPlaylists:** Return a `Feed` instance instead of items ([7660450](https://github.com/absidue/YouTube.js/commit/766045049d7154866e6fe32f6d965025d736d77d))
* **OAuth2:** Rewrite auth module ([#661](https://github.com/absidue/YouTube.js/issues/661)) ([b6ce5f9](https://github.com/absidue/YouTube.js/commit/b6ce5f903fa2285cb381d73aedf02cc5e2712478))
* **parser:** Implement endpoint/command parsers ([#812](https://github.com/absidue/YouTube.js/issues/812)) ([7397aa3](https://github.com/absidue/YouTube.js/commit/7397aa3f6425cb2f3dcc625502fd1ce5a5db6db3))
* **parser:** Remove old comment node ([2f087d4](https://github.com/absidue/YouTube.js/commit/2f087d47a0199870b313717f3d01598f8168be4b))
* Remove `web.bundle.min` ([e54e499](https://github.com/absidue/YouTube.js/commit/e54e499ff553dab51e6d9d1aebc090b50fec29ba))
